...
Hello, my name is Jon Chun and I am an interdisciplinary ML/AI researcher and educator focused on bridging traditional academic divisions, AI research, industry best practices, and related meaningful social topics like government regulation, ethics and entrepreneurship.  I focus on ML/AI approaches to language, narrative, emotion, cognition, and persuasion/deception using data science, statistical machine learning and deep learning including NLP, LLM, and LMM.  I also work on eXplainable AI (XAI), fairness-accuracy-transparency-explainability (FATE), AI ethical auditing and AI regulation. 

I have been a lifetime entrepreneur and innovator in diverse fields including network security, education, finance, insurance, and healthcare. My collaborator and I presented the first interdisciplinary research at major conferences and journals like Narrative and the Modern Language Association (MLA). To the best of our knowledge, we founded the world’s first human-centered AI curriculum in 2016 to engage domain experts from every discipline from literature to music to political science to economics. We coined the term ‘AI Digital Humanities’ and have mentored over 300 ML/AI DH projects with <a href="https://digital.kenyon.edu/dh/">over 56,000 download top institutions worldwide as of July 2024</a>. We are currently co-principal investigators for the US NIST AI Safety Consortium and the IBM-Notre Dame AI Tech Ethics Lab.

Previously, I co-founded the world’s largest privacy and anonymity website with investors including <a href="https://www.iqt.org/">In-Q-Tel</a>. I took over as CEO to pivot the company in the face of collapsing ad revenue, co-authored several patents on the first browser-based VPN appliance and successfully sold my Silicon Valley startup to Symantec. There, as a Director of Development, I oversaw the successful launch of our rebranded product. After serving as CIO for the premier boutique return to work firm in Silicon Valley, I co-founded and was CTO for two international startups in Latin America and Japan. In medical school, I was an American Heart Association research fellow and published on gene therapy and the first web-based electronic medical record system in the American Medical Informatics Journal. In grad school, I was the first US-based Japanese localization engineer for DELL and first engineer analyst of Japanese patents for the US semiconductor consortium SEMATECH. Previously, I worked in financial reporting in Tokyo, the Lawrence Berkley Labs’ synchrotron facility (ALS), and Computer Associates serving the aerospace IT industry.

There isn’t a topic I’m not curious about although keeping up with AI is my obsession. It’s a exiting to work at the epicenter of technology that mirrors core human trait in a field that progresses weekly and is poised to terraform every sphere of humanity. I have enjoyed working with the exceptionally driven, curious and intelligent teams on high-impact projects. I like collaboration, creative engineering, beautiful design, presentations, and sales. I speak English (native), Spanish (US Foreign Service Exam), Japanese (日本語能力試験), French (college) and would like a chance to relearn my forgotten Chinese (college).
...
I created the open-source library SentimentArcs in 2019, at the time the largest ensemble for diachronic sentiment analysis and the basis for Katherine Elkins's “The Shape of Stories” (Cambridge UP 2022). I presented some of the earliest GPT-2 story generation work at Narrative2020 and has since published in Cultural Analytics and Narrative on AI and Narrative. He has mentored approximately three hundred computational Digital Humanities projects since 2017 and across virtually every department at Kenyon College as part of the Integrated Program for Humane Studies and the Scientific Computing programs. I co-founded the AI Digital Humanities Colab, the world's first human-centered AI Digital Humanities curriculum at Kenyon, and our AI research colab. I currently have research papers pending on using LLMs to compare multiple translations of Proust, multimodal (dialog+image) diachronic sentiment arcs of classic Hollywood genres, as well as a novel benchmark on semantic similarity, IP infringement and creativity using Narrative theory. I'm currently working on AI persuasion, manipulation and deception as well as using LLMs for predictive analytics and decision-making on structured tabular data. (July 2024)
...
* <a href="https://techethicslab.nd.edu/call-for-proposals/">"How Well Can GenAI Predict Human Behavior? Auditing State-of-the-Art Large Language Models for Fairness, Accuracy, Transparency, and Explainability (FATE)"</a> IBM-Notre Dame AI Tech Ethics Grant (Associated Paper forthcoming)
...
* <a href="https://openreview.net/forum?id=pmUUK1CKI5&noteId=pmUUK1CKI5">"AIStorySimilarity: Quantifying Story Similarity Using Narrative for Search, IP Infringement, and Guided Creativity"</a> (OpenReview.net in review for CoNLL)
...
* <a ref="https://github.com/jon-chun/multisentimentarcs">"A Novel Method to Visualize Multimodal AI Sentiment Arcs in Long-Form Narratives"</a> (Frontiers in CS, accecpted in review)
...
* <a ref="https://github.com/jon-chun/AI-LIT">"AI-LIT: What is a Translator? Literary Translation in the Age of Large Language Models"</a> (Frontiers in CS, accepted in review)
