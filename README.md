...
I'm a lifetime entrepreneur and innovator in diverse fields from network security and education to finance, insurance, and healthcare. I've presented and published the first interdisciplinary AI research on storytelling and emotion at major conferences and journals like Narrative and the Modern Language Association (MLA). In 2016 I co-founded the world’s first human-centered AI curriculum to engage domain experts from every discipline from literature and music to political science to economics. We coined the term ‘AI Digital Humanities’ and have mentored over 300 ML/AI DH projects with <a href="https://digital.kenyon.edu/dh/">over 56,000 downloads from top institutions worldwide as of July 2024</a>. I'm a co-principal investigator for the US NIST AI Safety Institute representing the Modern Language Assocation and with the IBM-Notre Dame Tech Ethics Lab researching LLM prediction capabilities.

Previously, I co-founded the world’s largest privacy and anonymity website with investors including <a href="https://www.iqt.org/">In-Q-Tel</a>. I took over as CEO to pivot the company in the face of collapsing ad revenue, co-authored several patents on the first browser-based VPN appliance and successfully sold the Silicon Valley startup to Symantec. There, as a Director of Development, I oversaw the successful launch of our rebranded product. Before that, I served as CIO for the premier boutique return to work firm in Silicon Valley and co-founded and was CTO for two international startups in Latin America and Japan. In medical school, I was an American Heart Association research fellow and published on gene therapy and the first web-based electronic medical record system in the American Medical Informatics Journal. In grad school, I was the first US-based Japanese localization engineer for DELL and first engineer analyst of Japanese patents for the US semiconductor consortium SEMATECH. I also worked in financial reporting in Tokyo, the Lawrence Berkley Labs’ synchrotron facility (ALS), and Computer Associates serving the aerospace IT industry.

There isn’t a topic I’m not curious about although keeping up with AI is my obsession. It’s exciting to work at the epicenter of a technology that mirrors core human traits in a field that progresses weekly and is poised to terraform every sphere of humanity. I have enjoyed working on exceptionally driven, focused, curious and creative teams on high-impact projects. I like collaboration, creative engineering, beautiful design, presentations, and sales. I speak English (native), Spanish (US Foreign Service Exam), Japanese (日本語能力試験), French (college) and would like a chance to relearn my forgotten Chinese (college).
...
* <a href="https://techethicslab.nd.edu/call-for-proposals/">"How Well Can GenAI Predict Human Behavior? Auditing State-of-the-Art Large Language Models for Fairness, Accuracy, Transparency, and Explainability (FATE)"</a> IBM-Notre Dame Tech Ethics Lab Grant (paper forthcoming)
...
* DESCRIPTION: A novel benchmark for long-form, complex text similarity using narrative with applications for search, infringement, and collaborative creativity (under review)

ANONIMIZED ABSTRACT:
This study introduces an innovative benchmark for measuring the semantic resemblance between extensive narratives, addressing the shortcomings of traditional NLP text similarity metrics. Grounded in narrative theory and scriptwriting principles, the proposed method evaluates story similarity across key narrative elements and over 30 associated sub-features. Utilizing an advanced language model, the benchmark extracts and compares these elements from a diverse array of popular films. The research juxtaposes human evaluations with similarity scores computed via three approaches: element extraction from scripts, direct script assessment, and narrative element generation from language model knowledge. This benchmark represents a pioneering effort in quantifying long-text story similarity using a comprehensive narrative theory framework.

* DESCRIPTION: A novel method to extract multimodal diachronic sentiment arcs from long-Form stories (accecpted, under review)

ANONIMIZED ABSTRACT:
This paper presents an innovative approach to sentiment analysis in complex, multimodal narratives, addressing the implications of AI's growing influence on human autonomy. The proposed framework combines sentiment analysis techniques, time series transformations, narrative theory, and SOTA open-source AI models to examine sentiment expression across two primary modalities in long-form video content. While demonstrated with films, the methodology is adaptable to various multimodal narrative formats. This research represents a pioneering effort in multimodal Affective AI integration, enabling interactive human exploration and analysis of extended narratives. By utilizing open-source components runnable on accessible hardware, this study aims to democratize AI research and enhance Digital Humanities by allowing non-specialists to engage directly with Affective AI and human-AI alignment investigations.

* DESCRIPTION: Using LLMs to compare and assess literary translations of classic novels (accepted under review)

ANONIMIZED ABSTRACT:
This paper addresses the inadequacy of current machine translation metrics in evaluating literary translations, which demand consideration of the translator's creative role. Utilizing state-of-the-art language models, the study introduces new methodologies that extend beyond small-scale fidelity assessments. The research employs dynamic word embeddings to enhance context evaluation and cross-linguistic feature comparison. A highly debated multi-translation literary work is analyzed as a case study, highlighting how different translators' choices align with various translation theories. The findings reveal that AI-driven analysis can illuminate aspects of translation previously underdeveloped in translation studies, such as temporal evolution of writing style and emotional language.

* <a href="">"Near to Mid-term Risks and Opportunities of Open-Source Generative AI"</a> ICLR 2024, May 7-11, Vienna, Austria
...
* <a ref="https://arxiv.org/pdf/2402.01651">"Informed AI Regulation: Comparing the Ethical Frameworks of Leading LLM Chatbots Using an Ethics-Based Audit to Assess Moral Reasoning and Normative Values"</a> ArXiv.org (Jan 9, 2024)
...
* <a href="https://www.euppublishing.com/doi/abs/10.3366/ijhac.2023.0310?journalCode=ijhac">"The Crisis of Artificial Intelligence: A New Digital Humanities Curriculum for Human-Centred AI</a> International Journal of Humanities and Arts Computing
